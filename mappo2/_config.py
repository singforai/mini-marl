...
def get_config() -> argparse.ArgumentParser:
    ...
    # env setting
    param("--max_episodes", type=int, default=50000, help="Number of episodes trained")
    ...
    # batch setting
    param("--sampling_batch_size", type=int, default=1, help="batch size of data when the model samples the episode")
    param(
        "--training_batch_size",
        type=int,
        default=1,
    ...
    param("--penalty_lr", type=float, default=0.001, help="penalty에 곱해지는 스케일링 값")
