...
class R_Actor(nn.Module):
    ...
    def __init__(self, args, obs_space, action_space, use_softmax_temp, t_value,  device=torch.device("cpu")):
        ...
        self._use_naive_recurrent_policy: bool = args.use_naive_recurrent_policy
        ...
        self.act = ACTLayer(
            use_softmax_temp, t_value, action_space, self.hidden_size, self._use_orthogonal, self._gain
        )

        self.to(device)

    def forward(
        self, obs, rnn_states, masks, t_value, available_actions=None, deterministic=False
    ):
        """
