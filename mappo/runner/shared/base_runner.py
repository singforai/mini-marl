...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.use_centralized_V:
            ...
            self.share_observation_space = MultiAgentObservationSpace([spaces.Box(self._obs_low, self._obs_high)
        ...
        # policy network
        self.policy = Policy(args = self.args,
        ...
        # buffer
        self.buffer = SharedReplayBuffer(args = self.args,
