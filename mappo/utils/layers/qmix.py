...
class QMixNet(nn.Module):
    def __init__(self, args):
        ...
        self.hyper_w1 = nn.Linear(args.state_shape, args.num_agents * args.qmix_hidden_dim)
        ...
        self.hyper_b2 = nn.Sequential(
            nn.Linear(args.state_shape, args.qmix_hidden_dim), nn.ReLU(), nn.Linear(args.qmix_hidden_dim, 1)
        )

    def forward(self, q_values, states):
        n_r_t, ep_len = states.shape[0], states.shape[1]
        q_values = q_values.squeeze(-1).reshape(-1, 1, self.args.num_agents)
